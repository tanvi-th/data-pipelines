...
def main():
    ...
    try:
        ...
        logger.info("CONSUMED MESSAGES FOR {} SECONDS".format(max_duration))
        if data:
            ...
            logger.info("{} HAS BEEN UPLOADED TO S3 LOCATION - {}/{}".format(file_name, bucket, key))
        else:
            logger.error("************************NO MESSAGES PRESENT IN KAFKA************************")
